...
KeyDetails::KeyDetails(const Key InKey, const String & InLongDisplayName, const uint8 InKeyFlags, const String & InShortDisplayName)
	: _Key(InKey)
...
KeyDetails::KeyDetails(const Key InKey, const String & InLongDisplayName, const String & InShortDisplayName, const uint8 InKeyFlags)
	: _Key(InKey)
	, LongDisplayName(InLongDisplayName)
	, ShortDisplayName(InShortDisplayName)
{
...
void KeyDetails::CommonInit(const uint8 InKeyFlags)
{
